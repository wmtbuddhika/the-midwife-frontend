<div class="panel-body">
    <form role="form" class="form-horizontal father_data" id="wizard-validation">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    ?>" name="mother_nic_no" onblur="setSummary(this.name);checkNIC(this.value, 2)" required/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" value="" name="nic_no" onblur="setSummary(this.name);checkNIC(this.value, 3)" required/>
                                    <span id="father" class="label label-danger label-form"></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" value="" name="address" onblur="setSummary(this.name)"/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" value="" name="emergency_no" onblur="setSummary(this.name)"/>
                                </div>
                            </div>
...
<div class="modal animated fadeIn" id="modal_change_photo" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="photo_upload_father" method="post" enctype="multipart/form-data" action="../../after-child-registration.php">
                <div class="modal-body form-horizontal">
                    <div class="form-group">
                        <label class="col-md-3 control-label">New Photo</label>
                        <div class="col-md-7">
                            <input type="file" multiple id="file-simple" name="file"/>
                            <input type="hidden" name="photo_nic_father" id="photo_nic_father">
                            <input type="hidden" name="photo_nic_mother" id="photo_nic_mother">
                            <input type="hidden" name="photo_first_name_father" id="photo_first_name_father">
                            <input type="hidden" name="photo_last_name_father" id="photo_last_name_father">
                        </div>
                    </div>
                </div>
            </form>
