                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    ?>" name="mother_nic_no" onblur="setSummary(this.name)" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" value="" name="nic_no" onblur="setSummary(this.name)" required/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            if(!isset($_POST["photo_nic_mother"]) || $_POST["photo_nic_mother"] == "") {
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Mother NIC No *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="" id="mother_nic_no" disabled=""/>
                                    </div>
                                </div>
...
<div class="modal animated fadeIn" id="modal_change_photo" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="photo_upload_father" method="post" enctype="multipart/form-data" action="../../pre-mother-registration.php">
